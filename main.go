...
import (
	...
	"github.com/jvansan/golang-angular/handlers"
)
...
func main() {
	...
	// This will ensure that the angular file are served correctly
...
// CORSMiddleware is a simple middleware function to allow Cross Origin Resource Sharing
func CORSMiddleware() gin.HandlerFunc {
	return func(c *gin.Context) {
		c.Writer.Header().Set("Access-Control-Allow-Origin", "*")
		c.Writer.Header().Set("Access-Control-Allow-Headers", "Content-Type, Content-Length, Accept-Encoding, X-CRSF-Token, Authorization, accept, origin, Cache-Control, X-Requested-With")
